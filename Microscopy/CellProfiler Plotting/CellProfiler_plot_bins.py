...
# Plot number of cells at different locations of the scratch assay over time
#
...
if (len(sys.argv) != 3):
	print 'Usage: /usr/bin/python2 CellProfiler_plot_bins.py /path/to/Green.csv /path/to/Red.csv'
	sys.exit()
...
PLT.savefig('CellProfiler_Bins_1.png', dpi=120)
...
axarr[1, 1].set_xlim(xr)
axarr[1, 1].set_ylim(yr)
PLT.savefig('CellProfiler_Bins_2.png', dpi=120)
